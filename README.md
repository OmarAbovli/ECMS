...
*   **Backend:**
    *   [Python](https://www.python.org/) - The snake that powers it all.
    *   [FastAPI](https://fastapi.tiangolo.com/) - So fast, it's in the name.
    *   [SQLAlchemy](https://www.sqlalchemy.org/) - The magical ORM that talks to the database.
    *   [Uvicorn](https://www.uvicorn.org/) - The lightning-fast ASGI server.
*   **Database:**
    *   [SQLite](https://www.sqlite.org/index.html) - A tiny but mighty database.
*   **Frontend:**
...
Make sure you have Python 3 installed. Then, conjure the required packages from the `requirements.txt` file:
...
You have two options to run the application in development mode. Choose your destiny:
...
**Option 2: The Pro Gamer Move (with auto-reload)**

```bash
python -m uvicorn app.main:app --reload
```

The application will be available at `http://127.0.0.1:8000`. Go ahead, open it. We'll wait.

### 4. Build the Executable

Want to share this masterpiece with the world (or at least your colleagues)? You can bundle it into a single executable file for Windows.
...
```bash
python -m PyInstaller sys_app.spec
```
...
Don't be shy. We don't bite. (Unless you're a bug).

##  note   the  device iam useing to add a new stu is "RFID" ---->https://hdwrglobal.com/c/rfid/rfid-readers/




###### مره واحد منوفي راح يجيب تكيف لقاه غالي راح جايب لبوس خافض للحراره 
